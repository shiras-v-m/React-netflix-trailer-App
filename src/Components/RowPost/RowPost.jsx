...
function RowPost(props) {
 ...
 <button className='closeBtn' onClick={closeYoutbe}><span class="material-symbols-outlined">cancel</span></button><YouTube className='youtubeScreen' videoId={youtubeVideoId} opts={opts}  />
   </div>} 
